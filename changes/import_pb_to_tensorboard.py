...
Usage:
    $ python import_pb_to_tensorboard.py --model_dir="/tmp/mnist_model/1" --log_dir="/tmp/log"
    ...
    Model Imported. Visualize by running: tensorboard --logdir=/tmp/log

Slightly modified code from
tensorflow/tensorflow/python/tools/import_pb_to_tensorboard.py

See below for removed and added code.
"""
